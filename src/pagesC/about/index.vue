...
<template>
    <AppProvider>
        <view class="container">
            ...
            <view class="cell"><BasicButton @click="handleJump('/pagesC/log/index?id=4345&title=log')">log</BasicButton></view>
            <view class="cell" v-if="isLogin"><BasicButton @click="handleLoginOut">登出</BasicButton></view>
            <view class="cell" v-else>
                <BasicButton @click="handleJump('/pagesC/login/index')"> 登入 </BasicButton>
            </view>
        </view>
    </AppProvider>
</template>
